  ...
  body: z
    .object({
      ...
      recipeId: z.string().uuid({
        message: "L'id della ricetta base deve essere un UUID valido"
      }),
        ...
        .array(
          z.object({
            ingredientId: z.string().uuid({
              message: "L'id dell'ingrediente deve essere un UUID valido"
            }),
            categoriaId: z.string().uuid({
              message: "L'id della categoria deve essere un UUID valido"
            }),
