...
export const createOrderSchema = z.object({
  ...
  body: z
    .object({
      ...
      clienteId: z
        .string()
        .uuid({ message: "L'id cliente deve essere un UUID valido" }),
      ...
      items: z
        .array(
          z.object({
            prodottoId: z
              .string()
              .uuid({ message: "L'id prodotto deve essere un UUID valido" }),
            ...
            selections: z
              .array(z.string().trim())
              .max(10, { message: 'Massimo 10 personalizzazioni consentite' })
              .optional()
          })
        )
        .min(1, { message: "L'ordine deve contenere almeno un articolo" })
        .max(50, {
          message: 'Payload eccessivo: massimo 50 articoli per ordine'
        }) // Evita carico anomalo
    })
